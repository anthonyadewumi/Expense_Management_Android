...
class FinanceRequestLoadStateAdapter(private val adapter: FinanceRequestListAdapter
) : LoadStateAdapter<FinanceRequestLoadStateAdapter.NetworkStateItemViewHolder>() {
