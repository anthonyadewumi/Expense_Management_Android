...
class LocationUpdatesService : Service() {
    ...
    private val notification: Notification
        private get() {
            ...
            val builder: NotificationCompat.Builder = NotificationCompat.Builder(this)
                .addAction(
                    R.drawable.ic_logo, getString(R.string.settings),
                    activityPendingIntent
                )
                .addAction(
                    R.drawable.ic_baseline_cancel_24, getString(R.string.rejecte),
    ...
    private fun onNewLocation(location: Location) {
        ...
        Toast.makeText(this, "New location in background:$location", Toast.LENGTH_SHORT).show()
    ...
    companion object {
        private const val PACKAGE_NAME =
            "com.bonhams.expensemanagement.ui.gpsTracking"
         ...
         */
        private const val UPDATE_INTERVAL_IN_MILLISECONDS: Long = 100000
